...
namespace MCDawn
{
    public class Block
    {
        ...
        public const byte sandstone = (byte)50;
        
        public const byte flagbase = (byte)70;

        public const byte pushball = (byte)71;
        ...
        public const byte cmdblock = (byte)253;

        public const byte home_portal = (byte)254;
        ...
        public static bool command(byte type)
        {
            switch (type)
            {
                case Block.cmdblock:
        ...
        public static string Name(byte type)
        {
            switch (type)
            {
                ...
                case 50: return "sandstone";

                case 70: return "flagbase";

                case 71: return "pushball";
        ...
        public static byte Byte(string type)
        {
            switch (type.ToLower())
            {
                ...
                case "sandstone": return 50;

                //case "pushball": return 71;
        ...
        public static byte Convert(byte b)
        {
            switch (b)
            {
                case pushball: return red; // The ball itself in PushBall
                ...
                case home_portal: return waterstill;
