...
namespace MCDawn.Gui
{
    public partial class UpdateWindow : Form
    {
        ...
        private void UpdateWindow_Load(object sender, EventArgs e)
        {
            ...
            client.DownloadFile("http://www.mcdawn.tk/revs.php", "text/revs.php");
            listRevisions.Items.Clear();
            FileInfo file = new FileInfo("text/revs.php");
            StreamReader stRead = file.OpenText();
            if (File.Exists("text/revs.php"))
            {
        ...
        private void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            else { MCDawn_.Gui.Program.PerformUpdate(false); }
