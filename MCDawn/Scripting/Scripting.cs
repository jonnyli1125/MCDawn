...
namespace MCDawn
{
    static class Scripting
    {
        ...
        //private static string commandblocksourcepath = "extra/commandblock/source/";
        //private static string commandblockdllpath = "extra/commandblock/dll/";
        ...
        public static void CreateNew(string CmdName)
        {
            ...
            sw.Write(
                ...
                Environment.NewLine +
                "\tUse this as a basis for custom commands implemented via the MCDawn scripting framework." + Environment.NewLine +
                ...
                "// As a note, MCDawn is designed for .NET 3.5." + Environment.NewLine +
                "using System;" + Environment.NewLine +
                Environment.NewLine +
                "namespace MCDawn" + Environment.NewLine +
                "{" + Environment.NewLine +
        ...
        public static bool Compile(string commandName)
        {
            ...
            parameters.ReferencedAssemblies.Add("MCDawn_.dll");
        ...
        /// </summary>
        /// <param name="name">String to convert to an MCDawn class name.</param>
