...
namespace MCDawn
{
    public class CmdZone : Command
    {
        ...
        public override void Help(Player p)
        {
            ...
            Player.SendMessage(p, "/zone [add] [rank] - Creates a zone only [rank] and higher can build in");
            Player.SendMessage(p, "/zone [del] - Deletes all zones where clicked.");
            Player.SendMessage(p, "/zone [del] [all] - Deletes all the zones on the level.");
        }
