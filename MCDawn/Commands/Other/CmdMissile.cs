            ...
            Thread gunThread = new Thread(new ThreadStart(delegate
            {
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        for (i = 1; true; i++)
                        {
                            lookedAt.x = (ushort)Math.Round(startX + (double)(a * i * d));
                            lookedAt.y = (ushort)Math.Round(startY + (double)(c * i));
                            lookedAt.z = (ushort)Math.Round(startZ + (double)(b * i * d));
                        ...
                        lookedAt.x = (ushort)Math.Round(startX + (double)(a * (i - 1) * d));
                        lookedAt.y = (ushort)Math.Round(startY + (double)(c * (i - 1)));
                        lookedAt.z = (ushort)Math.Round(startZ + (double)(b * (i - 1) * d));
