...
namespace MCDawn
{
    public class CmdCuboid : Command
    {
        ...
        public override string[] aliases { get { return new string[] { "z", "bhb", "blb", "box" }; } }
        ...
        void BufferAdd(List<Pos> list, ushort x, ushort y, ushort z) { Pos pos; pos.x = x; pos.y = y; pos.z = z; list.Add(pos); }
        ...
        public enum SolidType { solid, hollow, walls, holes, wire, random };
    }
}